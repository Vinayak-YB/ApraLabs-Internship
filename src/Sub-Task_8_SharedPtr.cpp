...
int main()
{
	...
	for (int i = 0; i < num; i++) {
		...
		cin >> Shp.type;
		if (Shp.type == "Circle") {
			auto c1 = std::shared_ptr<Circle>(new Circle());
			cout << "\nEnter Radius :";
			cin >> c1->radius; // Accessing members method 1 //
			cout << "\nEnter Color :";
			cin >> c1->color;
			...
			auto r1 = std::shared_ptr<Rectangle>(new Rectangle());
			cout << "\nEnter Breadth :";
			cin >> r1->b;
			cout << "\nEnter Height :";
			cin >> r1->h;
			...
			auto t1 = std::shared_ptr<Triangle>(new Triangle());
			cout << "\nEnter Base :";
			cin >> t1->b;
			cout << "\nEnter Height :";
			cin >> t1->h;
